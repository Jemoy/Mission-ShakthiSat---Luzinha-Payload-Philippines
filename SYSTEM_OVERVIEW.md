...
CubeSat. It measures the optical, thermal and radiation environment of the orbit,
and records how three commercial memory technologies behave under that radiation.
...
- Measures incident optical flux using four silicon photodiodes of two device
  types.
